...
One of the original pictures and the rendering results are as Figure~\ref{fig:Kobe} (the training dynamics will be posed later with the background scene).
...
Each training takes about \textbf{20 minutes}(10000 epochs), the rendering results and training dynamics are as Figure~\ref{fig:Astronauts}, Figure~\ref{fig:Bunnys} and Figure~\ref{fig:Blosses}.

\begin{figure}[h]
	\centering
	
	% 四个子图并排，宽度设为 0.22\textwidth（合计 0.88，剩余由 \hfill 分配间距）
	\begin{subfigure}{0.2\textwidth}
		\centering
	...
	\begin{subfigure}{0.2\textwidth}
		...
		\label{Astronaut Color}   % 子图标签保留原样
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.2\textwidth}
		\centering
	...
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectB/astronauts.png}
		\caption{Astronauts}
	\end{subfigure}
	
	\caption{Astronauts}   % 总标题
	\label{fig:Astronauts} % 总标签
\end{figure}
...
\begin{figure}[h]
	...
	% 四个子图并排，宽度设为 0.22\textwidth（四个合计 0.88，剩余由 \hfill 分配间距）
	\begin{subfigure}{0.2\textwidth}
		\centering
	...
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectB/bunnys.png}
		\caption{Bunnys}
	\end{subfigure}
...
In this section, Figure~\ref{fig:OriginalCs} is trained.
...
\begin{figure}[h]
	...
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/firekeeper_rgba.png}
		\caption{Firekeeper(threestudio)}
	\end{subfigure}
	\hspace{0.02\textwidth}  % 固定小间距，比 \hfill 更紧凑
	% 第二张图（右边）
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/cute_robot_rgba.png}
		\caption{Cute Astronaut Robot(Ours)}
	\end{subfigure}
	
	\caption{Original Cs}
	\label{fig:OriginalCs}
\end{figure}


Each training takes about \textbf{30min}(coarse)+\textbf{30min}(refine), the rendering results (Fig~\ref{fig:Firekeepers}, Fig~\ref{fig:firekeeper_vertical}, Fig~\ref{fig:Robots}, Fig~\ref{fig:Robot_vertical}) and training dynamics(Fig~\ref{fig:objectC_losses}) are showed.
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Firekeepers}  % \caption 在前
	\label{fig:Firekeepers} 
...
\begin{figure}[h]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/firekeeper1.png}
	\end{minipage}
	\hfill  % 水平间距
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/firekeeper2.png}
	\end{minipage}
	
	\vspace{0.3cm}  % 行间距（与您原来保持一致）
	
	% 第二行：两张图并排
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/firekeeper3.png}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/firekeeper4.png}
	\end{minipage}
	
	\caption{Different Viewpoints}
	\label{fig:firekeeper_vertical}   % 原 label 完全保留
\end{figure}
...
\begin{figure}[h]
	...
	% 第一行：robot1 和 robot2 并排
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/robot1.png}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/robot2.png}
	\end{minipage}
	
	\vspace{0.3cm}  % 行间距，与原代码一致
	
	% 第二行：robot3 和 robot4 并排
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/robot3.png}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/robot4.png}
	\end{minipage}
	
	\caption{Different Viewpoints}
	\label{fig:Robot_vertical}   % 原标签完全保留
\end{figure}
...
\begin{figure*}[h]
	...
	%==================== 第一行：前两张原图 + 第三张（loss_sd）====================
	\begin{subfigure}[t]{0.31\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/opaque_loss.png}
		\caption{Firekeeper(threestudio)}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.31\textwidth}
		\centering
		\includegraphics[width=\linewidth]{figures/task1/objectC/sparsity_loss.png}
		\caption{Cute Astronaut Robot(Ours)}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.31\textwidth}
	...
	\label{fig:objectC_losses}   % 沿用原来的标签，您也可以改为 fig:RenderingCs
\end{figure*}
