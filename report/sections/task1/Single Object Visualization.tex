...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Original Cs}  % \caption 在前
	\label{fig:OriginalCs} 

\end{figure}


Each training takes about \textbf{30min}(coarse)+\textbf{30min}(refine), the rendering results (Fig~\ref{fig:Firekeepers}, Fig~\ref{fig:firekeeper_vertical}, Fig~\ref{fig:Robots}, Fig~\ref{fig:Robot_vertical}, Fig~\ref{fig:RenderingCs}) and training dynamics(Fig~\ref{fig:objectC_losses}) are showed.
...
\begin{figure}[h]
	...
	\begin{subfigure}{0.48\textwidth}
		...
		\caption{Cute Astronaut Robot(Ours)}
	\end{subfigure}
	\caption{Rendering Result}  % \caption 在前
	\label{fig:RenderingCs} 
\end{figure}
