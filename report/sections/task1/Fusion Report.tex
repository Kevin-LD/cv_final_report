...
Here are some pictures of our fusion results, some include all objects, while some pick one from each category:
...
Else, the rendered videos are provided in the appendix (see Item~\ref{app:models}).